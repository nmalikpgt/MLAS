...
/*	@After
	...
	public void test() throws Exception {
		...
		// Confirm SRO as External User - valid and complete (select yes for
...
//		element.sendKeys("test2");
		...
		Thread.sleep(2000);
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"noticeRequireId\"]/option[1]"))).click();
