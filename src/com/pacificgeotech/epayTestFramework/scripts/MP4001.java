...
public class MP4001 {
	...
	public void test() throws Exception {
		...
		// .xpath("//aside[@id='left-panel']/navigation-widget/div/nav/ul/li[5]/a/span")));
		// element.click();
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@placeholder='Claim Number']")).sendKeys(mp2b002.getClaimId());
