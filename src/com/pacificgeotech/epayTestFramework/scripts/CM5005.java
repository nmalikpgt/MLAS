...
public class CM5005 {
	...
	public void test() throws Exception {
		...
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("option[value=\"string:01")))
				.click();
		...
		new WebDriverWait(driver, 50).until(ExpectedConditions.elementToBeClickable(By.name("incorpPlace")));
		new Select(driver.findElement(By.name("incorpPlace"))).selectByVisibleText("CANADA");
...
element.click();
		...
		new WebDriverWait(driver, 50)
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='content']/div/div/div[3]/a/span")));
		((org.openqa.selenium.JavascriptExecutor) driver).executeScript("window.scrollTo(0, 2300)");
