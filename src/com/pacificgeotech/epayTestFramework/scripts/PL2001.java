	...
	public void test() throws Exception {
		...
		Thread.sleep(1000);
		 ...
		 ("remote".equals(urlInfo[1])) {
		  lgn1001.switchLocalRemote(urlInfo[1], urlInfo[0], getPid(),
		  getPin()); } else {
		...
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.name("effectiveDateInput"))).click();
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.name("effectiveDateInput"))).clear();
		Thread.sleep(500);
