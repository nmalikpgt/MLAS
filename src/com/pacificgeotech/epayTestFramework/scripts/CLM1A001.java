...
//
	...
	public void test() throws Exception {
		...
		System.out.println("pin and pid: " + newPl1001.getPid() + " " + newPl1001.getPin());
		...
		//driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//header[@id='header']/cata-header/div/div[2]/ul[2]/li[2]/a/span"))).click();
		//driverWait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("span.pull-left.ng-binding"))).click();
	...
	//	mp1001.test();
		...
		System.out.println("Last pin and Last pid: " + mp5003.getPid() + " " + mp5003.getPin());
		...
		String actualString1 = driverWait.until(ExpectedConditions.presenceOfElementLocated(
				By.xpath("//*[@id=\"widget-grid\"]/conf-msg/div/span"))).getText();
		Assert.assertTrue(actualString1.contains("Claim transfer successfully initiated. Note: The Claim Transfer submission is given allotted time to complete within: 15 minutes."));

	System.out.print("Claim transfer successfully initiated. Note: The Claim Transfer submission is given allotted time to complete within: 15 minutes.");
