...
public class CM3009 {
	...
	public void test() throws Exception {
		...
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//header[@id='header']/cata-header/div/div[2]/ul[2]/li[3]/a/span"))); 
		 element.click();
		 Thread.sleep(1000);
		    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//header[@id='header']/cata-header/div/div[2]/ul[2]/li[3]/ul/li[3]/a/div"))); 
		 element.click();
		...
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@type='text']")))
				.sendKeys(String.valueOf(cm2001.getClientNumber()));
		...
		element = driverWait.until(
				ExpectedConditions.presenceOfElementLocated(By.linkText("Confirm")));
		element.click();
		...
		new WebDriverWait(driver, 50)
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text(), 'Deceased')]")));

		// set to active
		new Select(driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("clientStatusId"))))
