...
public class PlanDo3rdPartyVerifications {
	...
	public void test() throws Exception {
		...
		CheckPlanSubmissionElevationCandidate checkplansubmissionelevationcandidate = new CheckPlanSubmissionElevationCandidate();
		checkplansubmissionelevationcandidate.test();
		setLicenceId(checkplansubmissionelevationcandidate.getLicenceId());
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@placeholder='Reference Number']")).sendKeys(checkplansubmissionelevationcandidate.getLicenceId());
		...
		((org.openqa.selenium.JavascriptExecutor) driver).executeScript("window.scrollTo(0, 2300)");
		 ...
		 new Select(element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("notificationTypeId0")))).selectByVisibleText("Email");

		    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("circulationModeId0"))); 
		 element.click();
		    ...
		    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("circulationModeId1"))); 
		 element.click();
		    new Select(element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("circulationModeId1")))).selectByVisibleText("Regular Mail");

		    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("notificationTypeId2"))); 
		 element.click();
		    new Select(element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("notificationTypeId2")))).selectByVisibleText("Email");
	
		    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("circulationModeId2"))); 
		 element.click();
