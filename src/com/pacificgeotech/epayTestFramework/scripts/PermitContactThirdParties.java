...
public class PermitContactThirdParties {
	...
	public void test() throws Exception {
		...
		PermitPreparePackage permitpreparepackage = new PermitPreparePackage();
		permitpreparepackage.test();
		setPermitId(permitpreparepackage.getPermitId());
		Thread.sleep(1500);
		...
		driver.findElement(By.xpath("//input[@placeholder='Reference Number']"))
				.sendKeys(permitpreparepackage.getPermitId());
