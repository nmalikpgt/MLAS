...
public class ADMIN7007 {
	...
	public void test() throws Exception {
		...
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text(), 'Pending')]")))
				.click();
		...
		Thread.sleep(4000);
		String bodyText = driver.findElement(By.linkText("Manage")).getText();
		Assert.assertTrue("Text not found!", bodyText.contains("Manage"));
