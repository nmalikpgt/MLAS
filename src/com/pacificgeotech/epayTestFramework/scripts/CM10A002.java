...
public class CM10A002 {
	...
	public void test() throws Exception {
		...
		String pin = null;
		String pass = null;
		java.sql.Connection con2 = DriverManager.getConnection("jdbc:oracle:thin:@orca3:1521:test", "PROXY_MAM",
				"PROXY_MAM");
		try {
		...
		driverWait.until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text(), 'Incorrect Password')]")))
				.getText();
		driverWait
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[contains(text(), 'Incorrect Pin')]")))
				.getText();
