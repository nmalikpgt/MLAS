...
public class STDISP75002 {
	...
	public void test() throws Exception {
		...
		setNewLeaseNo(disp712345.NewLeaseNo());
		...
		Thread.sleep(1000);
		// assign to all
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("Map Tech")));
		element.click();
		Thread.sleep(4000);
		...
		element = driverWait.until(
				ExpectedConditions.presenceOfElementLocated(By.id("miningRightId")));
		element.sendKeys(String.valueOf(disp712345.NewLeaseNo()));
