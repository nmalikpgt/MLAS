...
public class PlanPrepareReferralPackageDeliverListParties {
	...
	public void test() throws Exception {
		...
		PlanAddAmendremoveListItemsConfirmList PlanAddAmendremoveListItemsConfirmList = new PlanAddAmendremoveListItemsConfirmList();
		PlanAddAmendremoveListItemsConfirmList.test();
		setLicenceId(PlanAddAmendremoveListItemsConfirmList.getLicenceId());
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@placeholder='Reference Number']")).sendKeys(PlanAddAmendremoveListItemsConfirmList.getLicenceId());
		...
		new WebDriverWait(driver, 50).until(ExpectedConditions.presenceOfElementLocated(
				By.xpath("//*[contains(text(), 'Prepare referral package and deliver it to list parties has been successfully completed')]")));
