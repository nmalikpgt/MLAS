...
public class ASRET {
	...
	public void test() throws Exception {
		...
		element.click();
		new Select(
				element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("selectLengthOfTimeId"))))
						.selectByVisibleText("Number of Days from Current Date");

		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("numberOfDaysInputId")));
		element.clear();
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("numberOfDaysInputId")));
		element.sendKeys("100");
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("decisionOrderTypeId")));
		element.click();
		element = driverWait.until(ExpectedConditions
				.presenceOfElementLocated(By.id("commentInputId")));
		element.clear();
		element = driverWait.until(ExpectedConditions
				.presenceOfElementLocated(By.id("commentInputId")));
