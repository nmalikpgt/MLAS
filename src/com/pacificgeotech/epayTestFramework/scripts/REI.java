...
public class REI {
	...
	public void test() throws Exception {
	 ...
	 element.click();
	 Thread.sleep(1000);
	    new Select(element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("incidentTypeSltId")))).selectByVisibleText("Audit Request");

	 element.click();
	    new Select(element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("incidentCategorySltId")))).selectByVisibleText("Administrative");
	 ...
	 new WebDriverWait(driver, 50).until(ExpectedConditions.presenceOfElementLocated(By.xpath(
		...
		new WebDriverWait(driver, 50).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[class='ng-binding ng-scope']")));
