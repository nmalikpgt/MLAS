...
public class CLM3008 {
	...
	public void test() throws Exception {
		...
		new Select(driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("decisionCode"))))
				.selectByVisibleText("CANCELLED BY MINISTER");
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//option[@value='3']"))).click();
