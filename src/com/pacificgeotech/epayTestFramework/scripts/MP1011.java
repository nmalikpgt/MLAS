...
public class MP1011 {
	...
	public void test() throws Exception {
		...
		new WebDriverWait(driver, 50).until(ExpectedConditions.presenceOfElementLocated(By.xpath(
				"//*[contains(text(), 'Cells selected for registration must be abutting. They must have one common side')]")));
	...
	private void updateCellgridTable() throws ClassNotFoundException, SQLException {
		...
		String sql = ("UPDATE MTA_NTS_GRID_CELL SET CELL_STATUS_CODE = 'A', CELL_REASON_CODE = 'N', CELL_REOPENING_DATE = CELL_REOPENING_DATE  - 2  WHERE CELL_KEY_ID IN ('43B03C239','43B03C218')");
	...
	private void updateCellLockTable() throws ClassNotFoundException, SQLException {
		...
		Class.forName("oracle.jdbc.driver.OracleDriver");
		Statement stmt = con.createStatement();
		String sql = ("DELETE FROM MAM.MTA_GRID_LOCK_STATUS WHERE CELL_KEY_ID IN ('43B03C239','43B03C218')");
