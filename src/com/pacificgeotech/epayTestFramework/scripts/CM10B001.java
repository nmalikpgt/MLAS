...
public class CM10B001 {
	...
	public void test() throws Exception {
		...
		// driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//aside[@id='left-panel']/nav/ul/li[5]/a/b/em")));
		// element.click();
		WebElement elemFound = (new WebDriverWait(driver, 50)).until(ExpectedConditions.visibilityOfElementLocated(
				By.linkText("Admin")));
		driverWait.until(ExpectedConditions.presenceOfElementLocated(
				By.linkText("Admin"))).click();
		Thread.sleep(1000);
		...
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("goUnenrollBtnId")));
		element.click();
		...
		new WebDriverWait(driver, 50).until(ExpectedConditions.presenceOfElementLocated(
				By.xpath("//*[contains(text(), 'User pdeploymentp was successfully unenrolled')]")));
