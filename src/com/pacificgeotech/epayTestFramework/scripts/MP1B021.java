...
public class MP1B021 {
	...
	public void test() throws Exception {
		...
		PL3001 pl3001 = new PL3001();
		pl3001.test();

		setClientNumber(pl3001.getClientNumber());
		...
		element.clear();
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("clientselect")));
		element.sendKeys(pl3001.getClientNumber());
		...
		Assert.assertTrue("Text not found!", bodyText.contains("does not have a licence or holds an inactive licence"));
