...
public class Permit {
	...
	public void setLicenceId(String permitId) {
		PermitId = permitId;
	}
	...
	public void test() throws Exception {
		...
		element.click();
		Thread.sleep(15000);
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("permitActivityChkId0")));
		element.click();
		// Thread.sleep(1000);
		...
		Thread.sleep(1500);
		new WebDriverWait(driver, 150).until(ExpectedConditions.presenceOfElementLocated(
				By.name("fileInput")));
		Thread.sleep(3000);
		Object file = null;
		try {
		...
		new WebDriverWait(driver, 100).until(ExpectedConditions
				.visibilityOfElementLocated(By.cssSelector("[class='btn btn-labeled bg-color-greenDark txt-color-white']")));
		((org.openqa.selenium.JavascriptExecutor) driver).executeScript("window.scrollTo(0, 2300)");
		Thread.sleep(1000);
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[class='btn btn-labeled bg-color-greenDark txt-color-white']")))
				.click();
		Thread.sleep(1000);
		...
		PermitId = driver
				...
				.getText();
		setLicenceId(PermitId);
		System.out.println("Permit ID: " + getPermitId());

		/*
		 * element =
		 * driverWait.until(ExpectedConditions.presenceOfElementLocated(
		 * By.xpath(
		 * "//header[@id='header']/cata-header/div/div[2]/ul[2]/li[2]/a/span")))
		 * ; element.click(); element = driverWait
		 * .until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(
		 * "span.pull-left.ng-binding"))); element.click();
		 */
