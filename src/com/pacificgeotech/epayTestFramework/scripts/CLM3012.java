...
public class CLM3012 {
	...
	public void test() throws Exception {
		...
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("selectedGeoMapIds")))
				.sendKeys("NEED TO CHENGE THIS LATER...PUT CLAIM ID");
		...
		// driverWait.until(ExpectedConditions.presenceOfElementLocated(By.name("reopenPostingDateInput"))).sendKeys("2017-07-30");
