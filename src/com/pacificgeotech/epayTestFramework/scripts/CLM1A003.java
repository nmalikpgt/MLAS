...
public class CLM1A003 {
	...
	public void test() throws Exception {
		...
		System.out.println("Buyer Client Number " + pl1001.getClientNumber());
		setBuyerClientNumber(pl1001.getClientNumber());
		setBuyerPid(pl1001.getPid());
		setBuyerPin(pl1001.getPin());
		Thread.sleep(1500);
		...
		new WebDriverWait(driver, 50).until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("span.pull-left.ng-binding")));
