...
public class CLM3010 {
	...
	public void test() throws Exception {
		...
		new Select(driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("decisionCode"))))
				.selectByVisibleText("CANCELLED PURSUANT TO SECTION 46.1(4) OF THE MINING ACT");
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//option[@value='5']"))).click();
