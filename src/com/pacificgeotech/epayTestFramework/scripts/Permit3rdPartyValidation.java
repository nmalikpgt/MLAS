...
public class Permit3rdPartyValidation {
	...
	private String PermitId;
	  ...
	  @Test
		public void test() throws Exception {
			...
			PermitValidate permitvalidate = new PermitValidate();
			permitvalidate.test();
			setPermitId(permitvalidate.getPermitId());
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//input[@placeholder='Reference Number']")).sendKeys((CharSequence) permitvalidate.getPermitId());
