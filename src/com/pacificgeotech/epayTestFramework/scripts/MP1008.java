...
public class MP1008 {
	...
	public void test() throws Exception {
		...
		driver.getPageSource().contains("Current submitter is not agent for input owner");
	...
	private void updateCellgridTable() throws ClassNotFoundException, SQLException {
		...
		String sql = ("UPDATE MTA_NTS_GRID_CELL gc SET CELL_STATUS_CODE = 'A', CELL_REASON_CODE = 'N' WHERE gc.CELL_KEY_ID IN ('43B03C239','43B03C238','43B03C219','43B03C218')");
