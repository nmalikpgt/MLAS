...
public class PlanContactThirdpartiesPendingReplies {
	...
	public void test() throws Exception {
		...
		PlanPrepareReferralPackageDeliverListParties planpreparereferralpackagedeliverlistparties = new PlanPrepareReferralPackageDeliverListParties();
		planpreparereferralpackagedeliverlistparties.test();
		setLicenceId(planpreparereferralpackagedeliverlistparties.getLicenceId());
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@placeholder='Reference Number']")).sendKeys(planpreparereferralpackagedeliverlistparties.getLicenceId());
		...
		new WebDriverWait(driver, 50).until(ExpectedConditions.presenceOfElementLocated(
				By.xpath("//*[contains(text(), 'Contact third-parties with pending replies has been successfully completed')]")));
