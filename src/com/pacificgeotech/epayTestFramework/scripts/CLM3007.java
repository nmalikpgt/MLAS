...
public class CLM3007 {
	...
	public void test() throws Exception {
		...
		new Select(driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("decisionCode"))))
				.selectByVisibleText("CANCELLED BY ORDER OF MINING RECORDER");
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//option[@value='2']"))).click();
