...
public class PlanCheckPlanSubmissionElevationCandidateFinal {
	...
	public void test() throws Exception {
		...
		PlanContactThirdpartiesPendingReplies plancontactthirdpartiespendingreplies = new PlanContactThirdpartiesPendingReplies();
		plancontactthirdpartiespendingreplies.test();
		setLicenceId(plancontactthirdpartiespendingreplies.getLicenceId());
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@placeholder='Reference Number']")).sendKeys(plancontactthirdpartiespendingreplies.getLicenceId());
		...
		driverWait
				...
				.click();
		Thread.sleep(1000);
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[class='form-control ng-pristine ng-untouched ng-valid ng-empty']")));
		element.clear();
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[class='form-control ng-pristine ng-untouched ng-valid ng-empty']")));
		element.sendKeys(
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@placeholder='Instrument Number']")).sendKeys(plancontactthirdpartiespendingreplies.getLicenceId());
