...
public class CLM3015 {
	...
	public void test() throws Exception {
		...
		// driverWait.until(ExpectedConditions.presenceOfElementLocated(By.name("reopenPostingDateInput"))).sendKeys("2017-06-29");
