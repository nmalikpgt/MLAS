...
public class STDISP4a7007 {
	...
	public void test() throws Exception {
		...
		element.click();
		Thread.sleep(500);
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("nextBtnPayLaterId")));
		element.click();
		...
		try {
			...
			appElement = driverWait.until(ExpectedConditions
					.presenceOfElementLocated(By.xpath("//*[contains(text(), 'Lease ID: " + aral.getLeaseNo() + "')]")));
		...
		Assert.assertFalse("Text found!", bodyText.contains("Lease Renewal Application Assessment"));
