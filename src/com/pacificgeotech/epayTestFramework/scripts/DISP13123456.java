...
public class DISP13123456 {
	...
	public void test() throws Exception {
		...
		Thread.sleep(1000);
		driverWait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("Manage Mining Land Tenure Status")))
				.click();
		Thread.sleep(1000);
		...
		new Select(element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.name("tenureStatus"))))
				.selectByVisibleText("Active Partial Abandonment Pending");
		...
		element.click();
		element = driverWait
				.until(ExpectedConditions.presenceOfElementLocated(By.linkText("Manage Mining Land Tenure Status")));
		element.click();
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("miningRightNumber")));
		element.clear();
		element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("miningRightNumber")));
		...
		Thread.sleep(1500);
		new Select(element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.name("tenureStatus"))))
				.selectByVisibleText("Crown Land");
