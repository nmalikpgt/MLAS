...
public class CM10001 {
	...
	public void test() throws Exception {
		...
		WebElement successMesage10 = (new WebDriverWait(driver, 50))
	...
	//	element.click();
		 ...
		 * 
		 * 
		 * StringWriter Deactivate3 = new StringWriter();
		 * 
		 * Deactivate3.append(
		 * 
		 * 
		 * " UPDATE MAM.MTA_SEC_USER" + " SET ACTIVATED_IND = 'Y'" +
		 * " WHERE USER_NAME = 'pdeploymentp'" );
		 * 
		 * 
		 * java.sql.Statement st3 = con1.createStatement();
		 * System.out.println(Deactivate3.toString()); ResultSet rs3 =
		 * st3.executeQuery(Deactivate3.toString());
		 * 
		 * 
		 * StringWriter Deactivate4 = new StringWriter();
		 * 
		 * Deactivate4.append( " UPDATE TP_MAM.TP_USER" + " SET DISABLED = 1" +
		 * " WHERE USERNAME = 'pdeploymentp'");
		 * 
		 * 
		 * 
		 * java.sql.Statement st4 = con1.createStatement();
		 * System.out.println(Deactivate4.toString()); ResultSet rs4 =
		 * st4.executeQuery(Deactivate4.toString());
		 */
