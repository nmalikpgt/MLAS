	...
	private String PermitId;
	  ...
	  @Test
		public void test() throws Exception {
			...
			Permit3rdPartyValidation permit3rdpartyvalidation = new Permit3rdPartyValidation();
			permit3rdpartyvalidation.test();
			setPermitId(permit3rdpartyvalidation.getPermitId());
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//input[@placeholder='Reference Number']")).sendKeys((CharSequence) permit3rdpartyvalidation.getPermitId());
			...
			Thread.sleep(4000);
			 ...
			 element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//input[@type='checkbox'])[3]"))); 
			 element.click();
			    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//input[@type='checkbox'])[5]"))); 
			 element.click();
			    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//input[@type='checkbox'])[7]"))); 
			 element.click();
			    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("editReferralPackage0"))); 
			 element.click();
			 Thread.sleep(1000);
			    new Select(element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='wid-id-0']/div[1]/div/div[1]/div/div[2]/div[4]/div[2]/select")))).selectByVisibleText("Pending");
			    																								
			    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.name("responseDueDate"))); 
			 element.click();
			    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//button[@type='button'])[28]"))); 
			 element.click();
			    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.id("saveBtnId"))); 
			 element.click();
			    element = driverWait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//button[@type='button'])[8]"))); 
			 element.click();
			 ...
			 new WebDriverWait(driver, 50).until(ExpectedConditions.presenceOfElementLocated(
						By.xpath("//*[contains(text(), 'Add, amend, remove list items and/or confirm list has been successfully completed')]")));
	  }
