...
public class MP2005 {
	...
	public void test() throws Exception {
		...
		PL1001 pl1001a = new PL1001();
		pl1001a.test();
		setClientNumber(pl1001a.getClientNumber());
		Thread.sleep(1500);
		updateCellLockTable();
		Thread.sleep(4000);
		...
		new WebDriverWait(driver, 50)
				...
				.sendKeys(pl1001a.getClientNumber());
		...
		element.sendKeys(pl1001a.getClientNumber());
